...
public class Game_state8 {
	public static int scH,scW;
   
	Bitmap juqing_state8_dialog1;
	Bitmap juqing_state8_dialog2; 
	Bitmap juqing_state8_dialog3;
	Bitmap juqing_state8_dialog4;
	...
	public  Game_state8(Bitmap juqing_state8_dialog1,
			Bitmap juqing_state8_dialog2, Bitmap juqing_state8_dialog3,
			Bitmap juqing_state8_dialog4) 
	{
	       this.juqing_state8_dialog1=juqing_state8_dialog1;
	       this.juqing_state8_dialog2=juqing_state8_dialog2;
	       this.juqing_state8_dialog3=juqing_state8_dialog3;
	       this.juqing_state8_dialog4=juqing_state8_dialog4;
	       state8 =false;
	       is_dialog1=false;
	       is_dialog2=false;
	       is_dialog3=false;
	...
	public void draw1(Canvas canvas, Paint paint) {
	     ...
	     dialog_width=juqing_state8_dialog1.getWidth();
	     dialog_height=juqing_state8_dialog1.getHeight();
	     //获得新图片
	     Bitmap juqing_state8_dialog1_new  = Bitmap.createBitmap(juqing_state8_dialog1,0,0, dialog_width, dialog_height, matrix, true);
	     //对话框的位置
	     dialog_W=(scW-dialog_width)/2;
	     dialog_Hdown=(scH/3)*2;
	     dialog_Hup=scH/3;
	     canvas.drawBitmap(juqing_state8_dialog1_new,dialog_W,dialog_Hdown, paint);
	}
	public void draw2(Canvas canvas, Paint paint) {
	     ...
	     matrix.postScale(GamingPlaneTest.scaleWidth, GamingPlaneTest.scaleHeight);  
		//获得新图片
	     Bitmap juqing_state8_dialog2_new  = Bitmap.createBitmap(juqing_state8_dialog2,0,0, dialog_width, dialog_height, matrix, true);
	     canvas.drawBitmap(juqing_state8_dialog2_new,dialog_W,dialog_Hup, paint);
	}
	public void draw3(Canvas canvas, Paint paint) {
	     ...
	     matrix.postScale(GamingPlaneTest.scaleWidth, GamingPlaneTest.scaleHeight);  
		//获得新图片
	     Bitmap juqing_state8_dialog3_new  = Bitmap.createBitmap(juqing_state8_dialog3,0,0, dialog_width, dialog_height, matrix, true);
	     canvas.drawBitmap(juqing_state8_dialog3_new,dialog_W,dialog_Hdown, paint);
	}
	public void draw4(Canvas canvas, Paint paint) {
	     ...
	     matrix.postScale(GamingPlaneTest.scaleWidth, GamingPlaneTest.scaleHeight);  
		//获得新图片
	     Bitmap juqing_state8_dialog4_new  = Bitmap.createBitmap(juqing_state8_dialog4,0,0, dialog_width, dialog_height, matrix, true);
	     canvas.drawBitmap(juqing_state8_dialog4_new,dialog_W,dialog_Hup, paint);
	}
				...
				if (pointY > dialog_Hup && pointY < dialog_Hup + dialog_height ) 
				{
					 ...
					 if(is_dialog4)
				     {
				    	 ...
				    	 GameMenu.x=MainActivity.xValue;
							...
							GameMenu. game=3;
							GamingPlaneTest.bossArrayIndex=7;
				     }
